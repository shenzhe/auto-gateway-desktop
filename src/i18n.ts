...
const dictionaries = {
  en: {
    ...
    skillsLead: "Review, organize, and manage the Codex skills on this machine.",
    skillsTabInstalled: "Installed",
    skillsTabLibrary: "Skill library",
  ...
  zh: {
    ...
    skillsTitle: "技能管理",
    skillsLead: "查看、整理并管理本机的 Codex 技能。",
    skillsTabInstalled: "已安装",
    skillsTabLibrary: "技能库",
